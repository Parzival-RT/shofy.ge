                        ...
                        <div class="tp-shop-top-tab tp-tab me-0">
                            <ul class="nav nav-tabs" id="productTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button :class="{active: product.length >= 4}" class="nav-link " id="grid-tab" data-bs-toggle="tab" data-bs-target="#grid-tab-pane" type="button" role="tab" aria-controls="grid-tab-pane" aria-selected="true">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button :class="{active: product.length < 4}" class="nav-link me-0" id="list-tab" data-bs-toggle="tab" data-bs-target="#list-tab-pane" type="button" role="tab" aria-controls="list-tab-pane" aria-selected="false">
                ...
                <div class="tp-shop-main-wrapper">
                    <div class="tp-shop-items-wrapper tp-shop-item-primary">
                        ...
                        <div class="tab-content" id="productTabContent">
                            ...
                            <!-- First Tab Product View -->
                            <div :class="{'active show': product.length >= 4}" class="tab-pane fade " id="grid-tab-pane" role="tabpanel" aria-labelledby="grid-tab" tabindex="0">
                                <!-- Row -->
                                <div class="row infinite-container">
                                    ...
                                    <div class="col-6 col-lg-3 col-md-6 col-sm-6 infinite-item" v-for="(item, index) in product" :key="index">
                                        ...
                                        <!-- Product Modal -->
                                        <div class="modal fade tp-product-modal" :id="'producQuickViewModal_'+item.id" tabindex="-1" :aria-labelledby="'producQuickViewModal_'+item.id" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                ...
                                                <div class="modal-content">
                                                    <div class="tp-product-modal-content d-lg-flex align-items-start">
                                                        ...
                                                        <!-- Close Modal -->
                                                        <button type="button" class="tp-product-modal-close-btn" data-bs-toggle="modal" :data-bs-target="'#producQuickViewModal_'+item.id"><i class="tio-clear"></i></button>
                                                        <!-- End Close Modal -->
                                                        ...
                                                        <div class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                                                            <nav class="product-images">
                                                                <div class="nav nav-tabs d-inline-flex d-md-flex flex-nowrap flex-md-wrap flex-sm-column " id="productDetailsNavThumb_main" role="tablist">
                                                                    ...
                                                                    <button class="nav-link" :id="'nav-2-tab_'+item.id" data-bs-toggle="tab" :data-bs-target="'#nav-2'+item.id" type="button" role="tab" :aria-controls="'nav-2'+item.id" aria-selected="true">
                                                            ...
                                                            <div class="tab-content m-img" id="productDetailsNavContent_main">
                                                                <div class="tab-pane fade show active" :id="'nav-1'+item.id" role="tabpanel" :aria-labelledby="'nav-1-tab_'+item.id" tabindex="0">
                                                                    <div class="tp-product-details-nav-main-thumb">
                                                                        <img :src="item.image" alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="tab-pane fade" :id="'nav-2'+item.id" role="tabpanel" :aria-labelledby="'nav-2-tab_'+item.id" tabindex="0">
                                                                    <div class="tp-product-details-nav-main-thumb">
                                                                        <img :src="item.images[0].img" alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="tab-pane fade" :id="'nav-3'+item.id" role="tabpanel" :aria-labelledby="'nav-3-tab_'+item.id" tabindex="0">
                                                                    <div class="tp-product-details-nav-main-thumb">
                                                                        <img :src="item.images[1].img" alt="">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="tp-product-details-wrapper">
                                                            ...
                                                            <h3 class="tp-product-details-title">{{ item.title }}</h3>
                                                            ...
                                                            <!-- price and discount -->
                                                            <div class="tp-product-badge position-static mt-2" v-if="item.old_price">
                                                                <span class="product-offer">-{{ Math.round(((item.old_price - item.price) / item.old_price) * 100) }}%</span>
                                                            </div>
                                                            <div class="tp-product-details-price-wrapper mt-2 mb-20">
                                                                <span class="tp-product-details-price old-price me-1" v-if="item.old_price">{{  item.old_price + old_price }} ₾</span>
                                                            ...
                                                            <div class="tp-product-details-action-sm">
                                                                <button type="button" :class="item.wish_list_status ? 'text-danger' : ''" class="tp-product-details-action-sm-btn" @click="wish_list(item.id, item.image, item.title, item.type, item.old_price, item.price, 1)">
                                                                    ...
                                                                    <span class="ms-1" v-if="item.wish_list_status">ამოშალე სურვილების სიიდან</span>
                                                                    <span class="ms-1" v-else>დაამატე სურვილების სიაში</span>
                                                                </button>
                                                            </div>
                                                        </div>
                                                        <!-- End Product Details-->
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="tp-product-modal-content d-lg-flex align-items-start">
                                                                ...
                                                                <!-- Close Modal -->
                                                                <button type="button" class="tp-product-modal-close-btn" data-bs-toggle="modal" :data-bs-target="'#producQuickViewModal1_'+item.id"><i class="tio-clear"></i></button>
                                                                <!-- End Close Modal -->
                                                                ...
                                                                <div class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                                                                    <nav class="product-images">
                                                                        <div class="nav nav-tabs d-inline-flex d-md-flex flex-nowrap flex-md-wrap flex-sm-column " id="productDetailsNavThumb_main" role="tablist">
                                                                            <button class="nav-link active" :id="'nav-1_-tab_'+item.id" data-bs-toggle="tab" :data-bs-target="'#nav-1_'+item.id" type="button" role="tab" :aria-controls="'nav-1_'+item.id" aria-selected="true">
                                                                                <img :src="item.image" alt="">
                                                                            </button>
                                                                            <button class="nav-link" :id="'nav-2_-tab_'+item.id" data-bs-toggle="tab" :data-bs-target="'#nav-2_'+item.id" type="button" role="tab" :aria-controls="'nav-2_'+item.id" aria-selected="true">
                                                                                <img :src="item.images[0].img" alt="">
                                                                            </button>
                                                                            <button class="nav-link" :id="'nav-3_-tab_'+item.id" data-bs-toggle="tab" :data-bs-target="'#nav-3_'+item.id" type="button" role="tab" :aria-controls="'nav-3_'+item.id" aria-selected="true">
                                                                                <img :src="item.images[1].img" alt="">
                                                                            </button>
                                                                            <button class="nav-link" :id="'nav-4_-tab_'+item.id" data-bs-toggle="tab" :data-bs-target="'#nav-4_'+item.id" type="button" role="tab" :aria-controls="'nav-4_'+item.id" aria-selected="true">
                                                                                <img :src="item.images[2].img" alt="">
                                                                            </button>
                                                                            <!-- <button v-for="(item_image, index) in item.images" :key="index" class="nav-link" :id="'nav-3_-tab_'+index" data-bs-toggle="tab" :data-bs-target="'#nav-3'+index" type="button" role="tab" :aria-controls="'nav-3'+index" aria-selected="false">
                                                                                <img :src="item_image.img" alt="">
                                                                            </button> -->
                                                                        </div>
                                                                    </nav>
                                                                    <div class="tab-content m-img" id="productDetailsNavContent_main1">
                                                                        <div class="tab-pane fade show active" :id="'nav-1_'+item.id" role="tabpanel" :aria-labelledby="'nav-1_-tab_'+item.id" tabindex="0">
                                                                            <div class="tp-product-details-nav-main-thumb">
                                                                                <img :src="item.image" alt="">
                                                                            </div>
                                                                        </div>
                                                                        <div class="tab-pane fade" :id="'nav-2_'+item.id" role="tabpanel" :aria-labelledby="'nav-2-tab_'+item.id" tabindex="0">
                                                                            <div class="tp-product-details-nav-main-thumb">
                                                                                <img :src="item.images[0].img" alt="">
                                                                            </div>
                                                                        </div>
                                                                        <div class="tab-pane fade" :id="'nav-3_'+item.id" role="tabpanel" :aria-labelledby="'nav-3_-tab_'+item.id" tabindex="0">
                                                                            <div class="tp-product-details-nav-main-thumb">
                                                                                <img :src="item.images[1].img" alt="">
                                                                            </div>
                                                                        </div>
                                                                        <div class="tab-pane fade" :id="'nav-4_'+item.id" role="tabpanel" :aria-labelledby="'nav-4_-tab_'+item.id" tabindex="0">
                                                                            <div class="tp-product-details-nav-main-thumb">
                                                                                <img :src="item.images[2].img" alt="">
                                                                            </div>
                                                                        </div>
...
export default {
    ...
    watch: {
        ...
        // when user changes the quantity of the product this product_amount variable will be equal one/1
        product_amount: {
            handler(value) {
                if(value < 1) {
                    this.product_amount = 1;
                ...
                const input = document.querySelectorAll(".tp-product-details-quantity .tp-cart-input[type=text]");

                input.forEach(item => {
                    if (!numberPattern.test(item.value)) {
                        this.product_amount = 1;
                    }
                })
            }
