        ...
        <div class="container">
            ...
            <div class="row align-items-end mb-40">
                ...
                <div class="col-7">
                    ...
                    <h3 class="tp-section-title">პროდუქტები
                    </h3>
                    </div>
                </div>
                <!-- End col -->
            ...
            <div class="col-12">
                ...
                <div class="tp-shop-items-wrapper tp-shop-item-primary">
                    <div class="tab-content" id="productTabContent">
                        <div class="tab-pane fade active show" id="grid-tab-pane" role="tabpanel" aria-labelledby="grid-tab" tabindex="0">
                                        ...
                                        <div class="modal-content">
                                            <div class="tp-product-modal-content d-lg-flex align-items-start">
                                                ...
                                                <div class="tp-product-details-wrapper">
                                                    ...
                                                    <p>{{ item.description }} <span>ნახე მეტი</span></p>
                                                    ...
                                                    <div class="tp-product-details-action-item-wrapper d-sm-flex align-items-center">
                                                        ...
                                                        <div class="tp-product-details-add-to-cart mb-15 w-100">
                                                            <button class="tp-product-details-add-to-cart-btn w-100" @click="fill_cart_from_modal(item.id, item.image, item.title, item.type, item.old_price, item.price, product_amount)">დაამატე კალათაში</button>
                                                        </div>
                                                    </div>
                                                    <button class="tp-product-details-buy-now-btn w-100">ყიდვა</button>
                                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="tp-product-list-item d-md-flex" v-for="(item, index) in product" :key="index">
                                        ...
                                        <a href="#">
                                            <img class="bg-light" :src="item.image" alt="" style="width: 250px;">
                                        </a>
                                        ...
                                        <div class="tp-product-list-content">
                                            <div class="tp-product-content-2 pt-15">
                                                ...
                                                <div class="tp-product-list-add-to-cart">
                                                    <button class="tp-product-list-add-to-cart-btn">დაამატე კალათაში</button>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Product Modal -->
                                        <div class="modal fade tp-product-modal" :id="'producQuickViewModal1_'+item.id" tabindex="-1" aria-labelledby="producQuickViewModal" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="tp-product-modal-content d-lg-flex align-items-start">
                                                        ...
                                                        <div class="tp-product-details-wrapper">
                                                            ...
                                                            <!-- price -->
                                                            <div class="tp-product-details-price-wrapper mb-20">
                                                            <span class="tp-product-details-price old-price me-1">{{ item.old_price }}</span>
                                                            <span class="tp-product-details-price new-price">{{ item.price }}</span>
                                                            </div>
                                                            ...
                                                            <div class="tp-product-details-variation-item">
                                                                <h4 class="tp-product-details-variation-title">ფერი :</h4>
                                                            ...
                                                            <div class="tp-product-details-action-item-wrapper d-sm-flex align-items-center">
                                                                <div class="tp-product-details-quantity">
                                                                    <div class="tp-product-quantity mb-15 mr-15">
                                                                        ...
                                                                        <input class="tp-cart-input" type="text" v-model="product_amount"/>
                                                                        <span class="tp-cart-plus" @click="plus()">
                                                                            <svg width="11" height="12" viewBox="0 0 11 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                <path d="M1 6H10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                                                <path d="M5.5 10.5V1.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                                            </svg>
                                                                ...
                                                                <div class="tp-product-details-add-to-cart mb-15 w-100">
                                                                    <button class="tp-product-details-add-to-cart-btn w-100">დაამატე კალათაში</button>
                                                                </div>
                                                            </div>
                                                            <button class="tp-product-details-buy-now-btn w-100">ყიდვა</button>
                                                            </div>
...
export default {
    ...
    data() {
        return {
            ...
            product: Products,
            // when click product add cart button
            addItems: {},
            // Minimum product count for carts' products and of the modal product
            product_amount: 1,
            // Foreach product current price
            price: 0,
            // Foreach product old price
            old_price: 0
        }
    },
    methods: {

        /** these two functions do of the cart fill: 
        1) The first is filled with one : fill_cart()
        2) The second one fills in with a reference : fill_cart_from_modal()
        **/
        fill_cart(id, image, title, type, old_price, price, product_amount) {
            
            const productData = this.$store.state.cart_product;

            // this code product add/push once again in cart. e.g if product exist this code push once again product
        ...
        // this function add product from modal
        ...
        // These two functions are manipulating of the product_amount variable and plus and minus amount of the product
        plus(id) {
            this.product_amount++;
    ...
    watch: {
        // when user changes the amount of the product and he/she will use of the word: immediately the product equal 1
        product_amount: {
            handler(value) {
                if(value < 1) {
                    this.product_amount = 1;
