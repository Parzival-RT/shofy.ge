                        ...
                        <div class="row">
                            ...
                            <div class="tp-product-details-tab-nav tp-tab">
                                <nav>
                                    ...
                                    <span id="productTabMarker" class="tp-product-details-tab-line" style="left: 546px; display: block; width: 205px;"></span>
                                    </div>
                                </nav>  
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="tp-product-related-slider">
                            <div class="tp-product-related-slider-active swiper-container mb-10 swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                            <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(-1280px, 0px, 0px);" id="swiper-wrapper-790dcaddb78aef86" aria-live="polite"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 296px; margin-right: 24px;" role="group" aria-label="6 / 12" data-swiper-slide-index="1">
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" style="width: 296px; margin-right: 24px;" role="group" aria-label="7 / 12" data-swiper-slide-index="2">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate" style="width: 296px; margin-right: 24px;" role="group" aria-label="8 / 12" data-swiper-slide-index="3">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                ...
                                <div class="swiper-slide swiper-slide-prev" style="width: 296px; margin-right: 24px;" role="group" aria-label="5 / 12" data-swiper-slide-index="0">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                ...
                                <div class="swiper-slide swiper-slide-active" style="width: 296px; margin-right: 24px;" role="group" aria-label="6 / 12" data-swiper-slide-index="1">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                            <img src="assets/img/product/related/product-related-2.jpg" alt="">
                                ...
                                <div class="swiper-slide swiper-slide-next" style="width: 296px; margin-right: 24px;" role="group" aria-label="7 / 12" data-swiper-slide-index="2">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                            <img src="assets/img/product/related/product-related-3.jpg" alt="">
                                ...
                                <div class="swiper-slide" style="width: 296px; margin-right: 24px;" role="group" aria-label="8 / 12" data-swiper-slide-index="3">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                            <img src="assets/img/product/related/product-related-4.jpg" alt="">
                            ...
                            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" style="width: 296px; margin-right: 24px;" role="group" aria-label="5 / 12" data-swiper-slide-index="0">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                            <img src="assets/img/product/related/product-related-1.jpg" alt="">
                                ...
                                </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" style="width: 296px; margin-right: 24px;" role="group" aria-label="6 / 12" data-swiper-slide-index="1">
                                    <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                        <a href="product-details.html">
                                            <img src="assets/img/product/related/product-related-2.jpg" alt="">
                            ...
                            <div class="tp-related-swiper-scrollbar tp-swiper-scrollbar" style="transition-duration: 0ms;"><div class="tp-swiper-scrollbar-drag" style="transform: translate3d(214.358px, 0px, 0px); transition-duration: 0ms; width: 187.436px;"></div></div>
                        </div>
                    </div>
                </div>
            </section>
